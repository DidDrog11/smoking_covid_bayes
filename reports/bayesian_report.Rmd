...
drive_download("https://docs.google.com/spreadsheets/d/1VUY5xDLBpjNBovveg9wQrc0wbLhnEkmDPMR63rfj2-Y/edit?usp=sharing", path = here("data_spreadsheet", "data_extraction_current.xlsx"), overwrite = T)
...
my_bins <- c(0, 1, 5, 10, 20, 50, 70, 110)
mypalette <- leaflet::colorBin(palette="YlOrBr", domain=my_spdf@data$Number, na.color="transparent", bins=my_bins)
